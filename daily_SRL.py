...
def get_daily_papers(topic,query="SRL", max_results=2):
    """
    @param topic: str
    @param query: str
    ...
    # for result in tqdm(search_engine.results()):
    for result in tqdm(arxiv_client.results(search=search_engine)):
...
if __name__ == "__main__":
    ...
    keywords = dict()
    keywords["SRL"]  = "\"SRL\" OR \"safe RL\" OR \"safe reinforcement learning\" OR \"safety RL\" OR \"safety reinforcement learning\""
    # keywords["RRL"]  = "\"Robust RL\" OR \"Robust Reinforcement Learning\" OR \"Robust DRL\" OR \"Robust safe rl\""

    print("Entering Searching...")
    print("\n")
    for topic,keyword in keywords.items():
 
        # topic = keyword.replace("\"","")
        print("Keyword: " + topic)
        print("vocabulary: ", keyword)
